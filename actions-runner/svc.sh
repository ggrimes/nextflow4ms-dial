...
SVC_NAME="actions.runner.Nextflow4Metabolomics-nextflow4ms-dial.nextflow4ms-dial-mac"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (Nextflow4Metabolomics-nextflow4ms-dial.nextflow4ms-dial-mac)"
